...
copy "C:\OpenServer\domains\taxi2012\docker\fly\Dockerfile" "C:\OpenServer\domains\taxi2012\Dockerfile"
if %ERRORLEVEL% NEQ 0 (
...
copy "C:\OpenServer\domains\taxi2012\app\env\fly\.env" "C:\OpenServer\domains\taxi2012\.env"
if %ERRORLEVEL% NEQ 0 (
