...
class AndroidPas5Controller extends Controller
{
    ...
    {
        if (self::connectAPI() == 'http://188.190.245.102:7303') {
            (new IPController)->getIP('/android/PAS5/startPage');
        } else {
            (new IPController)->getIP('/android/PAS1/startPage');
        }
    }
...
//dd($rout);
        ...
        if ($connectAPI == 'http://188.190.245.102:7303') {
            $X_WO_API_APP_ID = config("app.X-WO-API-APP-ID-PAS5");
        } else {
