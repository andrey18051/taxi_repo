...
class WidgetsController extends Controller
{
    ...
    {
        return view("widgets.main");
    }
    public function job()
    {
        return view("widgets.job", ['services' =>  Services::all()->toArray()]);
    }
    ...
    public function getInfo(Request $req)
    {
        ...
        if ($message_error != "Надсилання заявки неможливе. Не заповнені поля: ") {
            return view('widgets.job', ['params' => $params,
        ...
        if (!empty($_GET['g-recaptcha-response'])) { //проверка на робота
            ...
            if ($out->success == true) {
                ...
                return view('widgets.job', ['params' => $params,
                    'services' => $servicesArr,
                    'info' => "Вашу заявку відправлено до вибраних Вами служб таксі. Чекайте на дзвінок, вайбер або відповідь на вказану Вами електронну пошту. Будемо раді бачити Вас у нашій команді професіоналів."]);
            }
        }
        if ($error) {
            return view('widgets.job', ['params' => $params,
