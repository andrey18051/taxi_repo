...
class CityPas4Controller extends Controller
{
...
//    }
    ...
    {
        return response()->json(City_PAS4::get());
    }
    ...
    {
        return City_PAS4::where('name', $city)->get()->toArray();
    }
...
//        $response = curl_exec($curlInit);
        ...
        $response = curl_exec($curlInit);
//dd($domainFull);
        $city = City_PAS4::where('address', $domain)->first();
...
//                    $alarmMessage->sendMeMessage($messageAdmin);
    ...
    {
        $cities = City_PAS4::all()->toArray();
        foreach ($cities as $value) {
            $city = City_PAS4::where('name', $value["name"])->first();
