...
return [
    ...
    */
    ...
    'between' => [
        ...
        'string' => 'Поле :attribute має бути між :min і :max символів.',
    ...
    'required_unless' => ':attribute поле обов`язкове, якщо :other не є в :values.',
    'required_with' => ':attribute поле обов`язкове, коли присутній :values.',
    'required_with_all' => ':attribute поле обов`язкове, коли присутні :values.',
    'required_without' => ':attribute поле обов`язкове, коли :values немає.',
    'required_without_all' => ':attribute поле обов`язково, якщо немає жодного з :values.',
    ...
    'search' => 'Адреси немає в базі',
    'search1' => 'Адреси немає в базі',
