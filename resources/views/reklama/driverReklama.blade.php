                    ...
                    <ul class="olderOne">
                        <li>
                            <a href="{{ route('callBackForm') }}">
                                ...
                                <p style="text-align: justify">
                                    Якщо хочеться відпочити та повеселитися на незапланованому заході що робити з автомобілем,
                                    адже залишити його на парковці біля ресторану або просто залишити у дороги не хочеться?
                                    В такому випадку вам неодмінно варто скористатися послугою "Тверезий водій" від служби
                                    «Таксі Лайт Юа». Професійний водій оперативно прибуде та сяде за кермо вашого автомобіля,
                                    доставивши його на  найближчу парковку  під ваш будинок.  Це зручно та безпечно, а зі
                                    службою «Таксі Лайт Юа», ще надійно та економно.
                                </p>
                                ...
                                <p style="text-align: justify">
                                    ...
                                    таксі. Для цього буде потрібно вказати маршрут майбутньої поїздки, а також дату і
                                ...
                                <p style="text-align: justify">
                                    Попереднє замовлення можна оформити за допомогою форми на нашому сайті, або
                                    залишити свій номер на сайті. Оператор розрахує точну вартість і
                                    підбере найбільш підходящий автомобіль.
                                </p>
