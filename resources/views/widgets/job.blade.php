                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingTwo">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                        Служби (Має бути зазначена хоча б одна служба.)
                                    </button>
                                </h2>
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="container">
                                                        <div class="row">
                                                            <p class="gradient">
                                                                За допомогою програми можна зробити легко крок для роботи на авто та відправити запит до служби як кандидата на співпрацю.
                                                            </p>
                                                            <p class="gradient">
                                                                Авто дозволяє працювати в будь-який зручний для Вас час без спеціальних умов, обов'язкових замовлень.
                                                            </p>
                                                            <p class="gradient">
                                                                Сервіс для тих, хто хоче заробити автомобілем, попутниками, окупити витрати на його утримання або розпочати власний бізнес у сфері перевезень. Робота з кількома фірмами без прив'язки до офісу та за вільним графіком.
                                                            </p>
                                                            <p class="gradient">
                                                            ...
                                                            <p class="gradient">
                                                                - Вибір зі списку видів маршрутів дозволені для Вас до виконання після реєстрації;
                                                            </p>
                                                            <p class="gradient">
                                                            ...
                                                            <p class="gradient">
                                                                - перехід у будь-який Ваш навігатор за будь-якими маршрутами клієнта;
                                                            </p>
                                                            <p class="gradient">
                                                            ...
                                                            <p class="gradient">
                                                                Влаштуватись у сервіс Драйвер дуже просто! Для цього необхідно встановити програму та заповнити дані. А після того, як заявку буде оброблено, прийде сповіщення, і можна приступати до роботи!
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
