...
<div class="container">
    <div class="header">
        <h4>Глибоко поважне панство доброго часу доби. Інформуємо Вас про новини, нові функції та розвиток додатків.</h4>
    </div>
    <div class="changes">
         <p>
             {{ $mes }}
    ...
    <div class="signature">
        <p>З найкращими побажаннями. Ми можемо вам допомогти у виготовленні шаблоних або індивідуальних додатків Андроід, телеграм ботів, сайтів. Отримати консультації по будь якому питанню стосуючих таксі в Україні. Очікуємо на ваші листи</p>
