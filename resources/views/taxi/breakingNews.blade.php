                    ...
                    <div class="row">
                        <ul class="olderOne">
                            <li>
                                <a href="{{route('homeCombo')}}">
                                    <h4 class="text-center"><b>{{ optional($news)->short ?? 'Новини відсутні' }}</b></h4>

                                    <p style="text-align: justify">
                                        {{ optional($news)->full ?? 'Опис новини недоступний' }}
                                    </p>
                                    <p>
                                        Джерело: <i>{{ optional($news)->author ?? 'Невідомий автор' }}</i>
                                    </p>
                                </a>
                            </li>
                        </ul>
                        ...
                        <div class="container-fluid" style="margin-top: 10px">
                            ...
                            <div class="header gradient">
                                ...
                                <a class="borderElement" href="{{ route('callBackForm') }}">Допомога у складний час</a>
