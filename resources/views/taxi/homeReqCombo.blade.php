        ...
        <form action="{{route('search-cost')}}" id="form">
            ...
            <div class="row">
                <div class="col-md-7 col-lg-8">
                     ...
                     <input type="hidden" class="form-control" id="user_phone" name="user_phone" value="{{$params['user_phone']}}">

                    <input type="hidden" id="user_full_name" name="user_full_name"  value="{{$params['user_full_name']}}">
