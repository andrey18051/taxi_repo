                    ...
                    <div class="container">
                        <div class="row gx-lg-5 align-items-center">
                            <div class="text-center">
                                ...
                                <p class="lead" style="text-align: justify">
                                    Ми цінуємо вашу довірливість та прагнемо забезпечити надійний захист ваших особистих даних. Ця політика конфіденційності пояснює, як ми збираємо, використовуємо та захищаємо ваші особисті дані в рамках використання нашої програми а також інших додатків, автором якіх є Андрей Коржов та Oleg Zinkovskii.
                                </p>
                                <h3>2. Збірні дані</h3>
                                <p class="lead" style="text-align: justify">
                                    Дані про електронну пошту користувача виходять через процес автентифікації за допомогою Firebase. Ця інформація використовується для ідентифікації та аутентифікації користувача у нашому додатку. Електронна пошта використовується для створення та керування обліковим записом користувача, забезпечення безпеки та відновлення доступу.
                                </p>
                                <p class="lead" style="text-align: justify">
                                ...
                                </p><p class="lead" style="text-align: justify">
                                    Дані про пристрій користувача виходять через процес відправлення токена пристрою на захищений сервер із використанням Firebase. Ця інформація використовується для надсилання персональних пуш-повідомлень користувачі в нашому додатку. Прийом пуш-повідомлень можна самостійно вимкнути у налаштуваннях пристрою.
                                </p>
                                ...
                                <p class="lead" style="text-align: justify">
                                    ...
                                    Ми докладаємо всіх зусиль для забезпечення безпеки ваших даних. Вся інформація, включаючи електронну пошту та номер телефону, зберігається у зашифрованому вигляді та доступ до неї обмежений лише авторизованим співробітникам.
                                </p>
