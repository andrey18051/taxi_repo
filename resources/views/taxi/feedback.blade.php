            ...
            <div class="container">
                <div class="row gx-lg-5 align-items-center">
                    <div class="col-lg-6 mb-5 mb-lg-0">
                        <h4 class="my-1 display-7 fw-bold ls-tight">
                                ...
                                @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-outline mb-4">
                                            <input type="email" class="form-control" name="email" placeholder="myemail@gmail.com">
                                        ...
                                        <div class="form-outline mb-4">
                                            <textarea name="message" id="message" class="form-control"   cols="50" rows="3"></textarea>
