            ...
            <div class="container">
                <div class="row gx-lg-5 align-items-center">
                    <div class="col-lg-6 mb-5 mb-lg-0">
                        ...
                        <h5 class="my-1 display-7 fw-bold ls-tight gradient" align="left">
                            Для видалення облікового запису на цьому сайті, а також мобільних додатків Андроїд, автором яких є Андрій Коржов або Oleg Zinkovskii, заповніть будь ласка форму на цій сторінці та надішліть повідомлення на електронну пошту адміністратору цього сайту.
                        </h5>
                        <h5 class="my-1 display-7 fw-bold ls-tight gradient" align="left">
