        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="card col-5">
                    ...
                    <h5> Тут выбираете пользователя для РУЧНОГО добавления в черный список</h5>
                </div>
                <div class="card offset-2 col-5">
                    ...
                    <h5> Сюда попадают или по выбору из списка блока Add слева от этого блока или после отработки в ПАС и получении там метки черного списка на телефон.
                        Чтобы удалить из черного спискам- выбирете нужную почту клиента и нажмите Удалть
                    </h5>
                </div>
