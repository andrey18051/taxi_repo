        ...
        <div style="width: 1200px; overflow-x: auto;">
            ...
            >
                ...
                <tr>
                    ...
                    <td> <input class="form-input input-lg" style="width: 80px" v-model="filters.online.value"  placeholder="Select by online"></td>
                    <td></td>
                </tr>
                <tr v-for="row in displayData" :key="row.id">
                    ...
                    <td>
                        <select id="online" class="form-control" style="width: 80px" v-model="row.online" required>
