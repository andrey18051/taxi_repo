<template>
    ...
    <div class="container-fluid" style="overflow-x: auto;">
        <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
                ...
                <h1 class="display-5">City PAS 1</h1>
...
export default {
    ...
    methods: {
        ...
        deleteCities(id) {
            ...
            axios.get('/pas1/city/destroy/'+ id)
                .then(response => {
        ...
        editCities(id, name, address, login, password, online, card_max_pay, bonus_max_pay, black_list, payment_flow) {
            axios.get('/pas1/city/edit/'+ id +'/'+name+'/'+address+'/'+login+'/'+password+'/'+ online+'/'+card_max_pay+'/'+ bonus_max_pay+'/'+ black_list+'/'+ payment_flow)
                .then(function(ret) {
        ...
        newCityButton() {
            axios.get('/pas1/city/newCityCreat')
                .then(res => {
