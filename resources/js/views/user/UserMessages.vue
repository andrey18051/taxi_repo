    ...
    <div class="container-fluid" style="overflow-x: auto;">
                ...
                <tr>
                    <td colspan="9">
                        ...
                        <div>
                            ...
                            <select v-model="selectedUser" id="userSearch" class="form-control">
                                <option v-for="user in users" :key="user.id" :value="user">
                                    {{ user.user_phone }} - {{ user.name }} - {{ user.email }}
                                </option>
                            </select>
        ...
        <div style="width: auto; overflow-x: auto;">
            ...
            >
                ...
                <v-th sortKey="user_phone"style="width: 300px">Phone</v-th>
                </thead>
                ...
                <tr>
                    ...
                    <td><input class="form-input input-lg" style="width: 200px" v-model="filters.user_phone.value"  placeholder="Select by user_phone"></td>
