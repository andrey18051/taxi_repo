<template>
    ...
    <div class="container">
        <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
                ...
                <h1 class="display-5">WAYFORPAY</h1>
        ...
        >
            ...
            <v-th sortKey="wfp_order_id"  style="width: 250px">номер платежа</v-th>
            <v-th sortKey="wfp_status_pay"  style="width: 100px">статус</v-th>
<!--            <v-th ></v-th>-->
            ...
            <tr>
                ...
                <td> <input class="form-input input-lg"  style="width: 250px" v-model="filters.wfp_order_id.value"></td>
                <td> <input class="form-input input-lg" style="width: 180px" v-model="filters.wfp_status_pay.value"></td>
<!--                <td></td>-->
            ...
            <tr v-for="row in displayData" :key="row.id">
                ...
                <td> <input id="wfp_order_id" class="form-control" style="width: 250px" v-model.text="row.wfp_order_id" required ></td>
                <td><input id="wfp_status_pay" class="form-control" style="width: 180px" v-model.text="row.wfp_status_pay" required ></td>
<!--                <td>-->
<!--                    <div class="btn-group" role="group">-->
<!--                        <button class="btn btn-success" @click="saveWfp_data(row.wfp_order_id)" style="margin-left: 5px">-->
...
export default {
    ...
    data: () => ({
        ...
        filters: {
            ...
            wfp_order_id: { value: "", keys: ["wfp_order_id"] },
            wfp_status_pay: { value: "", keys: ["wfp_status_pay"] },
            uid: { value: "", keys: ["uid"] },
    ...
    methods: {
        getWfp_data() {
            axios.get('/wfpData/all')
                .then(
                    res => {
                        this.wfp_data = res.data;
                        this.loading = false;
                    }
                )
        },
        ...
        saveWfp_data(wfp_order_uid) {
            axios.get('/wfpStatusReviewAdmin/'+ wfp_order_uid)
                .then(function(ret) {
