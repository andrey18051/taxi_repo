...
Route::get('/android/costSearch/{from}/{from_number}/{to}/{to_number}/{tarif}/{phone}/{user}/{services}/', [AndroidTestController::class, 'costSearch'])
    ->name('costSearch');
Route::get('/android/orderSearch/{from}/{from_number}/{to}/{to_number}/{tarif}/{phone}/{user}/{add_cost}/{time}/{comment}/{date}/{services}', [AndroidTestController::class, 'orderSearch'])
    ->name('orderSearch');
...
Route::get('/android/costSearchGeo/{originLatitude}/{originLongitude}/{to}/{to_number}/{tarif}/{phone}/{user}/{services}', [AndroidTestController::class, 'costSearchGeo'])
    ->name('costSearchGeo');
Route::get('/android/orderSearchGeo/{originLatitude}/{originLongitude}/{to}/{to_number}/{tarif}/{phone}/{user}/{add_cost}/{time}/{comment}/{date}/{services}', [AndroidTestController::class, 'orderSearchGeo'])
    ->name('orderSearchGeo');
...
Route::get('/android/orderSearchMarkers/{originLatitude}/{originLongitude}/{toLatitude}/{toLongitude}/{tarif}/{phone}/{user}/{add_cost}/{time}/{comment}/{date}/{services}', [AndroidTestController::class, 'orderSearchMarkers'])
    ->name('orderSearchMarkers');

Route::get('/android/versionAPI/', [AndroidTestController::class, 'version'])
    ->name('version');

Route::get('/android/myHistory/', [AndroidTestController::class, 'myHistory'])
    ->name('myHistory');
...
Route::get('/android/webordersCancel/{uid}', [AndroidTestController::class, 'webordersCancel'])
    ->name('webordersCancel');

Route::get('/android/historyUIDStatus/{uid}', [AndroidTestController::class, 'historyUIDStatus'])
