...
Route::get('/charge/{application}/{city}/{orderReference}/{amount}/{productName}/{clientEmail}/{recToken}', [WfpController::class, 'charge'])->name('charge');
Route::get('/purchase/{application}/{city}/{orderReference}/{amount}/{productName}/{recToken}', [WfpController::class, 'purchase'])->name('purchase');
...
Route::get('/purchase/{application}/{city}/{orderReference}/{amount}/{language}/{productName}/{clientEmail}/{clientPhone}', [WfpController::class, 'pay'])->name('purchase');
